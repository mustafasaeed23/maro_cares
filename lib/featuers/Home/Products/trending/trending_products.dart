...
class TrendingProductCarouselScreen extends StatefulWidget {
  const TrendingProductCarouselScreen({super.key});
...
class _TrendingProductCarouselScreenState extends State<TrendingProductCarouselScreen> {
